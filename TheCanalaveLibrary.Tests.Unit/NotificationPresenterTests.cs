...
public class NotificationPresenterTests
{
    ...
    private static NotificationCategoryEnum CategoryFor(NotificationTypeEnum type) => type switch
    {
        ...
        NotificationTypeEnum.StoryRelationshipRequested     => NotificationCategoryEnum.Collaborations,
        NotificationTypeEnum.StoryRelationshipApproved      => NotificationCategoryEnum.Collaborations,
