...
public sealed class NotificationTypeConfiguration : IEntityTypeConfiguration<NotificationType>
{
    public void Configure(EntityTypeBuilder<NotificationType> builder)
    {
        ...
        builder.HasData(
            ...
            // Reworded WU-TagFanon: covers every axis (characters AND settings/flat tags) — the
            // adoption invitation after a moderator links a custom-name group to an official tag.
            new { NotificationTypeId = NotificationTypeEnum.TagUpdateSuggestion, NotificationKey = "TagUpdateSuggestion", DisplayName = "Tag adoption suggested", Description = "A name you used in a story matches a new official tag.", NotificationCategory = NotificationCategoryEnum.YourStories, DefaultEmailEnabled = false, DefaultCollapsed = false },
            new { NotificationTypeId = NotificationTypeEnum.RecommendationRevised, NotificationKey = "RecommendationRevised", DisplayName = "Recommendation Revised", Description = "A recommendation you sent back for revision was edited and is live again.", NotificationCategory = NotificationCategoryEnum.YourStories, DefaultEmailEnabled = true, DefaultCollapsed = false },
            ...
            new { NotificationTypeId = NotificationTypeEnum.RecommendationRevisionRequested, NotificationKey = "RecommendationRevisionRequested", DisplayName = "Revision Requested", Description = "An author asked you to revise your recommendation.", NotificationCategory = NotificationCategoryEnum.YourRecommendations, DefaultEmailEnabled = true, DefaultCollapsed = false },

            // Collaborations (Category 5)
            new { NotificationTypeId = NotificationTypeEnum.StoryLineageRequested, NotificationKey = "StoryLineageRequested", DisplayName = "New Story Lineage Request", Description = "An author wants to link their story to yours.", NotificationCategory = NotificationCategoryEnum.Collaborations, DefaultEmailEnabled = true, DefaultCollapsed = false },
            new { NotificationTypeId = NotificationTypeEnum.StoryLineageApproved, NotificationKey = "StoryLineageApproved", DisplayName = "Story Lineage Approved", Description = "Your request to link to another story was approved.", NotificationCategory = NotificationCategoryEnum.Collaborations, DefaultEmailEnabled = true, DefaultCollapsed = false },
            ...
            new { NotificationTypeId = NotificationTypeEnum.ExternalAccountVerified, NotificationKey = "ExternalAccountVerified", DisplayName = "External Account Verified", Description = "A moderator confirmed your external platform account.", NotificationCategory = NotificationCategoryEnum.YourProfile, DefaultEmailEnabled = false, DefaultCollapsed = false },
            new { NotificationTypeId = NotificationTypeEnum.ExternalAccountRejected, NotificationKey = "ExternalAccountRejected", DisplayName = "External Account Not Verified", Description = "A moderator could not confirm your external platform account.", NotificationCategory = NotificationCategoryEnum.YourProfile, DefaultEmailEnabled = true, DefaultCollapsed = false },
            new { NotificationTypeId = NotificationTypeEnum.ExternalLinkVerified, NotificationKey = "ExternalLinkVerified", DisplayName = "External Link Verified", Description = "A moderator confirmed one of your \"also posted on\" links.", NotificationCategory = NotificationCategoryEnum.YourStories, DefaultEmailEnabled = false, DefaultCollapsed = false },
            new { NotificationTypeId = NotificationTypeEnum.ExternalLinkRejected, NotificationKey = "ExternalLinkRejected", DisplayName = "External Link Not Verified", Description = "A moderator could not confirm one of your \"also posted on\" links.", NotificationCategory = NotificationCategoryEnum.YourStories, DefaultEmailEnabled = true, DefaultCollapsed = false },
