...
{
    /// <inheritdoc />
    public partial class WU37_StructuredStoryTagging_ReadOnly : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date_moderated_removed = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    moderation_removal_reason = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true)
                },
                constraints: table =>
                {
