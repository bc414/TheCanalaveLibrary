...
namespace TheCanalaveLibrary.Server.Migrations
{
    ...
    [Migration("20260729022034_WU_SiteNews_SiteBlogPost")]
    partial class WU_SiteNews_SiteBlogPost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheCanalaveLibrary.Core.NotificationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            NotificationTypeId = (short)27,
                            DefaultCollapsed = false,
                            DefaultEmailEnabled = true,
                            Description = "A recommendation you sent back for revision was edited and is live again.",
                            DisplayName = "Recommendation Revised",
                            NotificationCategory = (short)2,
                            NotificationKey = "RecommendationRevised"
                        },
                        new
                        {
                        ...
                        new
                        {
                            NotificationTypeId = (short)43,
                            DefaultCollapsed = false,
                            DefaultEmailEnabled = true,
                            Description = "An author asked you to revise your recommendation.",
                            DisplayName = "Revision Requested",
                            NotificationCategory = (short)4,
                            NotificationKey = "RecommendationRevisionRequested"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("TheCanalaveLibrary.Core.RecommendationStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Description = "The story author requested a revision; hidden until the recommender edits it.",
                        ...
                        new
                        {
                            ...
                            Description = "Removed by the story author, not visible; blocked until the author unblocks it.",
                            StatusName = "Rejected"
                        });
                });
            ...
            modelBuilder.Entity("TheCanalaveLibrary.Core.SiteBlogPost", b =>
                {
                    b.HasBaseType("TheCanalaveLibrary.Core.BaseBlogPost");
                    ...
                    b.Property<bool>("NotifyAllUsers")
                        .HasColumnType("boolean")
                        .HasColumnName("notify_all_users");

                    b.Property<short>("Rating")
                        .HasColumnType("smallint")
                        .HasColumnName("rating");

                    b.ToTable("site_blog_posts", (string)null);
                });
            ...
            modelBuilder.Entity("TheCanalaveLibrary.Core.SiteBlogPost", b =>
                {
                    b.HasOne("TheCanalaveLibrary.Core.BaseBlogPost", null)
                        .WithOne()
                        .HasForeignKey("TheCanalaveLibrary.Core.SiteBlogPost", "BlogPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_site_blog_posts_base_blog_posts_blog_post_id");
                });
