...
**Retiring a pattern, term, or component.** When a WU retires one (a package, a component pair, a paradigm like device forks or a pre-flip render mode), grep all process docs for the retired name in the same WU — unswept references are how doc drift compounds.
