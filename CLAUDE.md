...
| `.claude/grid_axes.md` | Defines the 9 grid layers (columns) and 65 features (rows) in detail, including the MVP-line and post-MVP-line rationale. `status.md`'s rows are drawn from this file. | Rarely — only if a layer/feature axis itself changes (e.g. the 2026-07-06 Layer-7 dissolution, or the 2026-07-15 addition of Features 64–65 from `middle-addendum.md` §3) |
